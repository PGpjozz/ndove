...
from applications.views import ApplicationViewSet, LearnerViewSet
from company_profile.views import CompanyProfileViewSet
from enquiries.views import EnquiryViewSet
from gallery.views import GalleryPostViewSet
from programs.views import OpportunityViewSet, ProgramViewSet
...
router.register(r"gallery", GalleryPostViewSet, basename="gallery")
